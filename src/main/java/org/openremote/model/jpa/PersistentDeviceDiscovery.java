...
@Entity @Table(name = "discovered_device")
...
public class PersistentDeviceDiscovery extends DeviceDiscovery
{
  ...
  /**
   * TODO : this is causing the table to grow without bounds? Once processed, row should be deleted
   */
  ...
  public boolean isDeviceInDiscoveryQueue()
  {
    return isQueued;
  }
